            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="id_hak_akses" class="col-md-4 col-form-label text-md-right">{{ __('Hak Akses') }}</label>
                            
                            <div class="col-md-6">
                                <select id='id_hak_akses' name="id_hak_akses" class="form-control @error('id_hak_akses') is-invalid @enderror" >
