    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">Register Surat Keluar</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" action="{{route('suratKeluar.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="box-body">
                ...
                <div class="form-group @error('file_surat_keluar') has-error @enderror">
                    <label for="file_surat_keluar" @error('file_surat_keluar') class="control-label" @enderror>Masukkan File Surat Keluar</label>
